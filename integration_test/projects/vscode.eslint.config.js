...
export default tseslint.config(
  ...
  // All files (JS and TS)
  {
    ...
    rules: {
      ...
      'local/code-parameter-properties-must-have-explicit-accessibility':
        'warn',
    ...
    rules: {
      ...
      'no-restricted-syntax': [
        ...
        },
        {
          ...
          message:
            'Use DOM.isHTMLElement() and related methods to support multi-window scenarios.',
        },
        {
          selector: `BinaryExpression[operator='instanceof'][right.name=/^SVG\\w+/]`,
          message:
            'Use DOM.isSVGElement() and related methods to support multi-window scenarios.',
        },
        {
          selector: `BinaryExpression[operator='instanceof'][right.name='KeyboardEvent']`,
          message:
            'Use DOM.isKeyboardEvent() to support multi-window scenarios.',
        },
        {
          selector: `BinaryExpression[operator='instanceof'][right.name='PointerEvent']`,
          message:
            'Use DOM.isPointerEvent() to support multi-window scenarios.',
        },
        {
          ...
          paths: [
            {
              ...
              message:
                'Only net and system-preferences are allowed to be imported from electron',
            },
          ],
        },
      ],
  ...
  },
  {
    ...
    rules: {
      ...
      'local/code-limited-top-functions': [
        ...
        {
          'src/vs/workbench/contrib/notebook/browser/view/renderers/webviewPreloads.ts':
            ['webviewPreloads', 'preloadsScriptStr'],
        },
      ],
    },
  },
